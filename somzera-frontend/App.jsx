...
export default function App() {
  ...
  return (
    <div className="text-sz-dark h-screen flex flex-col overflow-x-hidden">
      <header className="bg-sz-dark text-sz-light h-16 flex items-center justify-between px-6 shadow-md border-b-4 border-sz-yellow relative z-20">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-full flex items-center justify-center shadow-inner border-sz-yellow overflow-auto">
            <img src="assets/images.png" alt="Logo Somzera" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-2xl font-bold tracking-widest text-sz-yellow italic">SOMZERA</h1>
          <span className="text-xs ml-2 text-sz-yellow align-bottom mt-2 font-bold bg-sz-blue px-1 rounded shadow-sm">ALPHA</span>
        </div>
      ...
      {/* Modal */}
      {isModalOpen && (
        <div id="custom-modal" className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center backdrop-blur-sm p-4">
          <div className="bg-sz-light border-2 border-sz-blue shadow-[0_10px_40px_rgba(0,0,0,0.8)] w-full max-w-sm rounded flex flex-col overflow-hidden aero-panel">
            ...
            <div className="p-5 flex flex-col items-center gap-4 text-center bg-gray-100">
              ...
              <p className="text-sm text-gray-800 font-bold">A funcionalidade de escrever novas reviews estará disponível na próxima versão BETA!</p>
