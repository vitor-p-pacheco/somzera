...
const tailwindConfig = {
  theme: {
    extend: {
      ...
      boxShadow: {
        "retro-button":
          "inset 1px 1px 0px rgba(255,255,255,0.8), inset -1px -1px 0px rgba(0,0,0,0.5), 1px 1px 3px rgba(0,0,0,0.3)",
        "retro-button-active": "inset 2px 2px 4px rgba(0,0,0,0.5)",
        "retro-panel":
          "inset 1px 1px 0px rgba(255,255,255,0.7), inset -1px -1px 0px rgba(0,0,0,0.4), 2px 2px 5px rgba(0,0,0,0.2)",
      },
      backgroundImage: {
        "glass-gradient":
          "linear-gradient(to bottom, rgba(255,255,255,0.3) 0%, rgba(255,255,255,0) 50%, rgba(0,0,0,0.1) 51%, rgba(0,0,0,0.2) 100%)",
